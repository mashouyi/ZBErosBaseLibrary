...
Pod::Spec.new do |s|
  ...
  s.version      = "0.1.0"
  s.summary      = "Eros基础库本地化"
  s.description  = <<-DESC
                   WeexEros iOS App base library Eros基础库本地化
                   DESC

  s.homepage     = "https://github.com/mashouyi/ZBErosBaseLibrary.git"
  s.license      = "MIT"
  s.author       = { "mashouyi" => "2720611375@qq.com" }

  s.platform     = :ios, "8.0"
  s.ios.deployment_target = "8.0"
  s.source       = { :git => "https://github.com/mashouyi/ZBErosBaseLibrary.git", :tag => s.version.to_s }
  s.requires_arc = true
